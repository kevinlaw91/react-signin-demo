...
export function GoogleSignInButton(): ReactElement {
  ...
  return (
    <button
      type="button"
      className="inline-flex items-center cursor-pointer justify-center w-full h-12 gap-3 px-5 py-3 font-semibold text-neutral-600 border border-neutral-200 rounded-xl bg-gray-200/50 hover:bg-gray-400/20 outline-hidden focus:ring-2 ring-primary ring-offset-1 duration-150"
