      ...
      <div className="space-y-3">
        <div>
          ...
          <input
            ...
            className="block w-full h-12 px-4 py-2 text-neutral-700 rounded-lg appearance-none bg-neutral-200 placeholder-neutral-400 outline-none focus:ring-1 focus:ring-neutral-400/50 ring-offset-0 sm:text-sm transition duration-150"
